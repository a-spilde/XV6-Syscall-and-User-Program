...
getcmd(char *buf, int nbuf)
{
  ...
  17:	6a 02                	push   $0x2
  19:	e8 e3 0c 00 00       	call   d01 <printf>
  memset(buf, 0, nbuf);
...
panic(char *s)
{
  ...
  61:	6a 02                	push   $0x2
  63:	e8 99 0c 00 00       	call   d01 <printf>
  exit();
...
00000090 <runcmd>:
{
  ...
  e2:	6a 02                	push   $0x2
  e4:	e8 18 0c 00 00       	call   d01 <printf>
    break;
 ...
 12c:	6a 02                	push   $0x2
 12e:	e8 ce 0b 00 00       	call   d01 <printf>
      exit();
...
execcmd(void)
{
 ...
 245:	6a 54                	push   $0x54
 247:	e8 e6 0c 00 00       	call   f32 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
 ...
 270:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 273:	6a 18                	push   $0x18
 275:	e8 b8 0c 00 00       	call   f32 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
 ...
 2bc:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 2bf:	6a 0c                	push   $0xc
 2c1:	e8 6c 0c 00 00       	call   f32 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
 ...
 2f6:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 2f9:	6a 0c                	push   $0xc
 2fb:	e8 32 0c 00 00       	call   f32 <malloc>
...
backcmd(struct cmd *subcmd)
{
 ...
 330:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 333:	6a 08                	push   $0x8
 335:	e8 f8 0b 00 00       	call   f32 <malloc>
...
000008b4 <parsecmd>:
{
 ...
 911:	6a 02                	push   $0x2
 913:	e8 e9 03 00 00       	call   d01 <printf>
    panic("syntax");
...
00000924 <main>:
{
 ...
 9d5:	6a 02                	push   $0x2
 9d7:	e8 25 03 00 00       	call   d01 <printf>
...
strlen(const char *s)
{
 ...
 a5e:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
...
putc(int fd, char c)
{
 ...
 c6e:	52                   	push   %edx
 c6f:	50                   	push   %eax
 c70:	e8 63 ff ff ff       	call   bd8 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 c96:	74 42                	je     cda <printint+0x60>
    neg = 1;
    x = -xx;
 c98:	f7 de                	neg    %esi
    neg = 1;
 ...
 cff:	eb ee                	jmp    cef <printint+0x75>
...
printf(int fd, const char *fmt, ...)
{
 ...
 d67:	08 d1                	or     %dl,%cl
 d69:	75 63                	jne    dce <printf+0xcd>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
 d6b:	83 f8 73             	cmp    $0x73,%eax
 d6e:	0f 84 84 00 00 00    	je     df8 <printf+0xf7>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
 ...
 d77:	0f 84 b7 00 00 00    	je     e34 <printf+0x133>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
 d7d:	83 f8 25             	cmp    $0x25,%eax
 d80:	0f 84 cc 00 00 00    	je     e52 <printf+0x151>
        putc(fd, c);
      } else {
 ...
 d8e:	e8 cd fe ff ff       	call   c60 <putc>
        putc(fd, c);
 d93:	89 fa                	mov    %edi,%edx
 d95:	8b 45 08             	mov    0x8(%ebp),%eax
 d98:	e8 c3 fe ff ff       	call   c60 <putc>
      }
      state = 0;
 d9d:	be 00 00 00 00       	mov    $0x0,%esi
 da2:	eb 8d                	jmp    d31 <printf+0x30>
        printint(fd, *ap, 10, 1);
 ...
 db6:	e8 bf fe ff ff       	call   c7a <printint>
        ap++;
 ...
 dc9:	e9 63 ff ff ff       	jmp    d31 <printf+0x30>
        printint(fd, *ap, 16, 0);
 ...
 de0:	e8 95 fe ff ff       	call   c7a <printint>
        ap++;
 ...
 df3:	e9 39 ff ff ff       	jmp    d31 <printf+0x30>
        s = (char*)*ap;
...
free(void *ap)
{
 ...
 e83:	eb 02                	jmp    e87 <free+0x19>
 e85:	89 d0                	mov    %edx,%eax
 e87:	39 c8                	cmp    %ecx,%eax
 e89:	73 04                	jae    e8f <free+0x21>
 e8b:	39 08                	cmp    %ecx,(%eax)
 e8d:	77 12                	ja     ea1 <free+0x33>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 e8f:	8b 10                	mov    (%eax),%edx
 e91:	39 c2                	cmp    %eax,%edx
 e93:	77 f0                	ja     e85 <free+0x17>
 e95:	39 c8                	cmp    %ecx,%eax
 e97:	72 08                	jb     ea1 <free+0x33>
 e99:	39 ca                	cmp    %ecx,%edx
 e9b:	77 04                	ja     ea1 <free+0x33>
 e9d:	89 d0                	mov    %edx,%eax
 e9f:	eb e6                	jmp    e87 <free+0x19>
      break;
...
morecore(uint nu)
{
 ...
 ef0:	77 05                	ja     ef7 <morecore+0x15>
    nu = 4096;
 ...
 f01:	50                   	push   %eax
 f02:	e8 39 fd ff ff       	call   c40 <sbrk>
  if(p == (char*)-1)
 f07:	83 c4 10             	add    $0x10,%esp
 f0a:	83 f8 ff             	cmp    $0xffffffff,%eax
 f0d:	74 1c                	je     f2b <morecore+0x49>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
 ...
 f18:	50                   	push   %eax
 f19:	e8 50 ff ff ff       	call   e6e <free>
  return freep;
 ...
 f30:	eb f4                	jmp    f26 <morecore+0x44>
...
malloc(int nbytes)
{
 ...
 f51:	74 04                	je     f57 <malloc+0x25>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 f53:	8b 01                	mov    (%ecx),%eax
 f55:	eb 4b                	jmp    fa2 <malloc+0x70>
    base.s.ptr = freep = prevp = &base;
 ...
 f7a:	eb d7                	jmp    f53 <malloc+0x21>
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
 f7c:	74 1a                	je     f98 <malloc+0x66>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
 ...
 fa7:	73 d3                	jae    f7c <malloc+0x4a>
    if(p == freep)
 fa9:	39 05 a4 16 00 00    	cmp    %eax,0x16a4
 faf:	75 ed                	jne    f9e <malloc+0x6c>
      if((p = morecore(nunits)) == 0)
 fb1:	89 d8                	mov    %ebx,%eax
 fb3:	e8 2a ff ff ff       	call   ee2 <morecore>
 fb8:	85 c0                	test   %eax,%eax
 fba:	75 e2                	jne    f9e <malloc+0x6c>
 fbc:	eb d4                	jmp    f92 <malloc+0x60>
